...
public class HandlerNotifier {
    ...
    private void indexHandlers() {
        ...
        for (Method method : declaredMethods) {
            if (method.isAnnotationPresent(com.antonioaltieri.telegram.botapi.MessageHandler.class)) {
                logger.info("Found MessageHandler: " + method.getName());
                com.antonioaltieri.telegram.botapi.MessageHandler messageHandlerAnnotation = method.getAnnotation(MessageHandler.class);
